package com.java_work.controller.classify;

import com.java_work.entities.ClassifyInfo;
import com.java_work.service.ClassifyInfoService;
...
public class UpdateClassifyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int i = service.updateClassify(info);
        if (i == 1) {
            // 添加成功
            msg = "修改成功";
            code = 0;
