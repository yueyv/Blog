package com.java_work.controller.url;

import com.java_work.entities.UrlInfo;
import com.java_work.service.UrlInfoService;
...
public class InsertUrlInfoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        UrlInfo urlInfo = ob.readValue(sb.toString(), UrlInfo.class);
        int i = urlInfoService.insertUrl(urlInfo);
        if (i == 1) {
            // 添加成功
            msg = "添加成功";
            code = 0;
