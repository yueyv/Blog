        ...
        setup(props) {
            ...
            onMounted(() => {
                ...
                axios.get("/user/showUserCount").then(res => {
                    var value = res.data < 10 ? "0" + res.data : res.data;
                    if (value > 0) {
                        var num = 0;
            ...
            const calculateDays = () => {
                var day = Math.floor(new Date().getTime() / 1000) - (new Date('2022-11-20 00:00:00')
                        .getTime() /
                        1000),
...
<style>
    ...
    .top_bg {
        width: 100%;
        height: 200px;
        background-image: url(../../../../assets/banner/banner01.png);
