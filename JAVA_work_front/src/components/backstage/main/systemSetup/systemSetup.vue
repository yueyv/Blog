...
<script>
    ...
    function loadData(state) {
        ...
        axios.get("/showAllSystemSetup").then(res => {
            state.stickArticleValue = res.data.stickArticle;
            state.allArticleValue = JSON.parse(res.data.allArticle);
            state.featuredArticleValue = JSON.parse(res.data.featuredArticle);
            state.technologyArticleValue = JSON.parse(res.data.technologyArticle);
            state.resourceArticleValue = JSON.parse(res.data.resourceArticle);
            state.advertising.advertisingImg1 = res.data.advertising1;
            state.advertising.advertisingLink1 = res.data.advertisingLink1;
            state.advertising.advertisingImg2 = res.data.advertising2;
            state.advertising.advertisingLink2 = res.data.advertisingLink2;
            state.advertising.advertisingImg3 = res.data.advertising3;
            state.advertising.advertisingLink3 = res.data.advertisingLink3;

            // 网站特效设置
            state.effects.effects01=res.data.effects01.toString();
            state.effects.effects02=res.data.effects02.toString();
        })
    }
    export default ({
        setup() {
            ...
            const state = reactive({
                ...
                // 广告上传到服务器的路径
                uploadURL: process.env.VUE_APP_URL + "/advertisingImgUpload",
            })
            ...
            const handleAvatarSuccess1 = (response) => {
                ...
                state.advertisingImg.advertising1 = response;
            }
            const handleAvatarSuccess2 = (response) => {
                state.advertisingImg.advertising2 = response;
            }
            const handleAvatarSuccess3 = (response) => {
                state.advertisingImg.advertising3 = response;
            }
