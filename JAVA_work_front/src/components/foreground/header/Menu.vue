<template>
    <div class="hidden-xs-only header-menu">
        <el-menu :default-active="route.path" @select="handleSect" :router="true" :ellipsis="false" class="el-menu-demo"
            ...
            <img src="../../../assets/logo.svg" style="cursor: pointer;width:40px;" alt="JAVA_work" @click="router.push({path:'/'})">
            <div class="flex-grow" />
            <el-menu-item index="/">
                <span>首页</span>
            </el-menu-item>
    ...
    <div class="hidden-sm-and-up header-img">
        <img src="../../../assets/logo.svg" style="cursor: pointer;width:140px;margin: 0 auto;" alt="JAVA_work"  @click="router.push({path:'/'})">
    </div>
