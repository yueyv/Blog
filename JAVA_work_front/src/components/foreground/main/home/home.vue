...
<script>
    ...
    function loadData(state) {
        ...
        axios.get("/showAllSystemSetup").then(res => {
            ...
            if (res.data.advertising2 != "" && !res.data.advertising2.includes('http')) {
                res.data.advertising2 = url + res.data.advertising2
            }
            if (res.data.advertising3 != "" && !res.data.advertising3.includes('http')) {
                res.data.advertising3 = url + res.data.advertising3
            }

            // 广告内容
            state.advertising1 = res.data.advertising1;
            state.advertisingLink1 = res.data.advertisingLink1;
            state.advertising2 = res.data.advertising2;
            state.advertisingLink2 = res.data.advertisingLink2;
            state.advertising3 = res.data.advertising3;
            state.advertisingLink3 = res.data.advertisingLink3;
        })
    }
